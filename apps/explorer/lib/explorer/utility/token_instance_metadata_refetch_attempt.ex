defmodule Explorer.Utility.TokenInstanceMetadataRefetchAttempt do
  ...
  ## Returns
    - `:ok` - If the retries number was successfully inserted into the database.
    - `{:error, reason}` - If there was an error inserting the retries number.

  """
  @spec insert_retries_number(Hash.Address.t(), non_neg_integer()) :: :ok | {:error, String.t()}
